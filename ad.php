    ...
    <div class="container">
      ...
      <div class="row feature-row">
        <div class="col-md-10 col-md-offset-1">
          <img class="img-responsive" src="img/ad-typography-and-cards.png" />
        </div>
      </div>
      <div class="row feature-row">
      ...
      <div class="row feature-row">
        <div class="col-md-12 px-0">
          <img class="img-responsive" src="img/ad-logo-ideation.png" />
        </div>
      </div>
      <div class="row text">
        <div class="col-md-8 col-md-offset-2">
      ...
      <div class="row pt-50">
        <div class="col-md-8 col-md-offset-2">
          <img class="img-responsive" src="img/ad-t-shirt.png" />
        </div>
      </div>
    </div>
    <div class="container">
