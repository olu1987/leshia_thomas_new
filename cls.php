    ...
    <div class="container">
      ...
      <div class="row feature-row">
        <div class="col-md-10 col-md-offset-1">
          <img class="img-responsive" src="img/cls-typography-and-cards.png" />
        </div>
      </div>
      <div class="row feature-row">
      ...
      <div class="row feature-row pb-50">
        <div class="col-md-8 col-md-offset-2 pb-50">
          <img class="img-responsive" src="img/cls-logo-ideation.png" />
        </div>
      </div>
      <div class="row text">
        <div class="col-md-8 col-md-offset-2">
