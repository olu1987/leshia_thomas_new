        ...
        <div class="col-md-6 col-md-offset-3 form-col">
            <form name="contactform" method="post" action="send_form_email.php">
                <div class="form-group row" style="display: none">
                    <label class="col-sm-3" for="misc">Misc *</label>
                    <div class="col-sm-9">
                        <input class="form-control" type="text" name="misc" maxlength="50" size="30">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-3" for="name">Name *</label>
                    <div class="col-sm-9">
                        <input class="form-control" type="text" name="name" maxlength="50" size="30">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    <label class="col-sm-3" for="telephone">Telephone Number</label>
                    <div class="col-sm-9" valign="top">
                        <input class="form-control" type="text" name="telephone" maxlength="30" size="30">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-3" for="countrySelect">Country *</label>
                    <div class="col-sm-9">
                    ...
                    <label class="col-sm-3" for="subjectSelect">Subject *</label>
                    <div class="col-sm-9">
                ...
                <div class="form-group row">
                    <div class="col-sm-12 text-right">
                        <input class="btn btn-md" type="submit" value="Send message">
                    </div>
                </div>
            </form>
        </div>
