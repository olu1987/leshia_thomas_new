...
<div class="row pt-20">
      <div class="col-md-6 col-md-offset-3 text-center">
          <img class="img-responsive page-header-logo" src="img/ocado-tile.png"/>
      </div>
  </div>
  <div class="row mb-50 text-center">
      <div class="col-md-6 col-md-offset-3 intro-col">
          ...
          <p>In an Interview process for a UI/UX designer role with Ocado, I was asked
            ...
            components and specifications from the current ocado UI library. Ocado were very pleased with the final
            deliverables.
          </p>
      </div>
  </div>  
